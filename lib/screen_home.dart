...
class _ScreenHomeState extends State<ScreenHome> {
  ...
  List popular = [];
  List common = [];
  final String apiKey = '96fb2e1cf5d10bdfb8be062dc78dcf78';
  final readAccessToken =
      'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI5NmZiMmUxY2Y1ZDEwYmRmYjhiZTA2MmRjNzhkY2Y3OCIsInN1YiI6IjYzODJkNmFiYTQxMGM4MDA4NDgyYzgwNSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.l2iNEWAudUlbw_bLiaMHpvAkBMsEzXbLWBifuTAUN0w';
  @override
  void initState() {
